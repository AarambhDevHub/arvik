...
- Focusing on what is best not just for us as individuals, but for the overall
  community
- Helping newcomers feel welcome — everyone starts somewhere
...
- Dismissing or attacking inclusion-related requests and discussions
...
- Any public or private communication when an individual is officially
...
**Discord:** Aarambh Dev Hub server → `#report` channel  
**GitHub:** Open a private security advisory (for sensitive reports) or
email the maintainer directly via GitHub profile contact.
